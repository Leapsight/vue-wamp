...
function plugin(Vue, options) {
  ...
  _connection.on_user_error = function (error, customErrorMessage) {
    if (options.hasOwnProperty('on_user_error') && typeof options['on_user_error'] === 'function') {
      options.on_user_error.apply(_connection, [error, customErrorMessage]);
    }
  };

  _connection.on_internal_error = function (error, customErrorMessage) {
    if (options.hasOwnProperty('on_internal_error') && typeof options['on_internal_error'] === 'function') {
      options.on_internal_error.apply(_connection, [error, customErrorMessage]);
    }
  };
  ...
  _connection.onchallenge = function (session, method, extra) {
    _session = session;
    if (options.hasOwnProperty('onchallenge') && typeof options['onchallenge'] === 'function') {
      options.onchallenge.apply(_connection, [session, method, extra]);
    }
  };
